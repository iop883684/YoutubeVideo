...
class BaseVC: UIViewController, UIGestureRecognizerDelegate {
    ...
    func addBtnBackNav(tinColor: UIColor? = nil) {
        let backButton = self.createBtnNavWithImage(image: #imageLiteral(resourceName: "ic_arrow_back"), target: self, action: #selector(BaseVC.actionTouchBtnBack), tinColor: tinColor)
    ...
    func addBtnLeftNavWithImage(image: UIImage?, tinColor: UIColor? = nil) {
        let leftButton = self.createBtnNavWithImage(image: image, target: self, action: #selector(BaseVC.actionTouchBtnLeft), tinColor: tinColor)
    ...
    func addBtnRightNavWithImage(image: UIImage?, tinColor: UIColor? = nil) {
        let rightButton = self.createBtnNavWithImage(image: image, target: self, action: #selector(BaseVC.actionTouchBtnRight), tinColor: tinColor)
    ...
    func addBtnLeftNavWithTitle(title: String?) {
        if let title = title {
            let leftNavBtn = UIBarButtonItem(title: title, style: .plain, target: self, action: #selector(BaseVC.actionTouchBtnLeft))
            self.navigationItem.leftBarButtonItem = leftNavBtn
        }
    }
    
    func addBtnRightNavWithTitle(title: String?) {
        let rightNavBtn = UIBarButtonItem(title: title, style: .plain, target: self, action: #selector(BaseVC.actionTouchBtnRight))
